...
![Forward grouping](/img/lindb/design/forward_grouping.png)
...
2. [_Akumuli Inverted Index_](https://akumuli.org/akumuli/2017/11/17/indexing/)
3. [_Counting Sort_](https://en.wikipedia.org/wiki/Counting_sort)
4. [_Trie_](https://en.wikipedia.org/wiki/Trie)
5. [_Succinct Data Structure_](https://en.wikipedia.org/wiki/Succinct_data_structure)
