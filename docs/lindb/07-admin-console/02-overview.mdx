...
- Alive Storage-Nodes list of current cluster,  see [cluster status information](/docs/lindb/admin-console/overview#storage-cluster-status) for more information;
...
![Node configuration](/img/lindb/guide/admin_ui/node_config.png#browser)
...
- See [database replica status](/docs/lindb/admin-console/monitoring#replication) for status of available database in the cluster

![Node configuration](/img/lindb/guide/admin_ui/storage_state.png#browser)
