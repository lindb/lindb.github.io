...
- 一个 Shard 可以有多个副本，详细请看[复制](/docs/lindb/design/replication)；
...
meta 和 index 相关结构请看[索引](/docs/lindb/design/inverted-index)。
...
![文件存储结构](/img/lindb/design/storage_sstable.png)
