...
- [General](/docs/lindb/reference/metric#general): General metrics, such as CPU, Mem, network, etc., applicable to Root, Broker, Storage;
- [Broker](/docs/lindb/reference/metric#broker): Broker internal monitoring metrics;
- [Storage](/docs/lindb/reference/metric#storage): Storage internal monitoring metrics;
