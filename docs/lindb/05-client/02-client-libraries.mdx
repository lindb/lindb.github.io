...
Implement write data SDK based on [LinDB API](/docs/lindb/api/index)，the following LinDB client libraries are available:

- [Go](/docs/lindb/client/go)
- [Java](/docs/lindb/client/java)
...
- [Write API Definition](/docs/lindb/api/insert);
...
![Async write](/img/lindb/design/async_client.png)
