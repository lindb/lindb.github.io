...
![Simple query](/img/lindb/design/simple_query.png)
...
![Complex query](/img/lindb/design/complex_query.png)
...
![Cross idc query](/img/lindb/design/cross_idc_query.png)
...
1. [_M3DB: Building a Query Engine for High Cardinality Time Series Data_](https://eng.uber.com/billion-data-point-challenge/)
2. [_Drill Query Execution_](https://drill.apache.org/docs/drill-query-execution/)
